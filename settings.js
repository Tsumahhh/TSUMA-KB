...
const dev = process.env.OWNER_NUMBER || '254743399594';
...
const herokuapikey = process.env.HEROKU_API_KEY || 'HRKU-526705a6-2bbd-4e48-984f-a9b98a90c334';
const herokuAppname = process.env.HEROKU_APP_NAME || 'Solomon Mbotia';
